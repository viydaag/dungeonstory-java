...
public class ProductForm extends CssLayout {
    ...
    protected NumberField stockCount = new NumberField("Stock");
    protected ComboBox availability = new ComboBox("Availablility");
    protected CategoryField category = new CategoryField("Category");
    ...
    public ProductForm(SampleCrudLogic sampleCrudLogic) {
        ...
        vLayout.addStyleName("form-layout");
        vLayout.addComponent(productName);
        vLayout.addComponent(price);
        vLayout.addComponent(stockCount);
        vLayout.addComponent(availability);
        vLayout.addComponent(category);
        vLayout.addComponent(save);
        vLayout.addComponent(cancel);
        vLayout.addComponent(delete);
